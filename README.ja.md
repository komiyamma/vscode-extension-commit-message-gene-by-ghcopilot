...
[![Version](https://img.shields.io/badge/version-v0.3.24-4094ff.svg)](https://marketplace.visualstudio.com/items?itemName=komiyamma.commit-message-gene-by-ghcopilot)
...
- GitHub Copilot サブスクリプション、または SDK で利用できる他の認証方法が使えること
- Node.js/TypeScript 向け SDK では Copilot CLI の個別インストールは不要です。SDK に同梱されています
